Ext.ns('sink', 'Ext.ux', 'demos.Data', '_2010', '_2005', '_Feedback');
...
Ext.ux.UniversalUI = Ext.extend(Ext.Panel, {
    ...
    items: [{
        cls: 'launchscreen',
        html: '<div><img src="resources/img/logo.png" /><h1>Abi 2000</h1><p>Informationen rund um unsere Jahrgangstreffen.</span></p></div>'
    }],
    backText: 'Back',
...
sink.Main = {
    init : function() {
        ...
        this.ui = new Ext.ux.UniversalUI({
            title: Ext.is.Phone ? 'Abi 2000' : 'GBG Seelze | Abi 2000',
